...
Overview: The game revolves around an adventurer heading into a cave looking for a antidote. The player is tasked with multiple options and has to make it to the end of the cave and retrieve the antidote. 
...
The architecture is a very basic code structure. Each chapter is broken down into seperate functions. Each chapter includes different loops and random variables. Each function moves onto a different function as the user moves on to a different chapter.
